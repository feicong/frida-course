 ...
 * Compile with:
 *
 * gcc -ffunction-sections -fdata-sections frida-core-example.c -o
 * frida-core-example -L. -lfrida-core -ldl -lm -lresolv -pthread
 * -Wl,--export-dynamic
 *
...
int main(int argc, char *argv[]) {
	...
	if (error == NULL) {
		...
		if (g_main_loop_is_running(loop)) g_main_loop_run(loop);
